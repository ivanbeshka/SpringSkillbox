...
public class BooksRestApiController {
    ...
    public ResponseEntity<List<Book>> booksByAuthorFirstName(@RequestParam("firstName") String firstName) {
        return ResponseEntity.ok(bookService.getBooksByAuthor(firstName));
    }
